...
My research interests include **multi-modal understanding** (vision-language models, multi-modal reasoning) and **trustworthy large models** (model alignment, robustness, fairness).
...
## News
<ul>
<li><strong>[Sep. 2025]</strong> Served as an Associate Editor of Neurocomputing</li>
<li><strong>[Sep. 2025]</strong> Served as an Area Chair of ICLR 2025</li>
...
## Alumni
<ul>
  <li><strong>Bowen Sun</strong>, Undergrad@Tsinghua -> PhD student@JHU, first-author oral paper at CVPR 2026</li>
  <li><strong>Samyak Rawlekar</strong>, PhD student@UIUC, first-author paper at CVPR 2026</li>
  <li><strong>Zhen He</strong>, Master@Chongqing University, first-author paper at ACL 2026</li>
  <li><strong>Jianing Chen</strong>, Master@CAS -> PhD student@The Hong Kong Polytechnic University, first-author papers at ICLR 2026 and NeurIPS 2025</li>
  <li><strong>Yike Wu</strong>, Undergrad@SEU -> PhD student@NTU, first-author paper at ICLR 2026</li>
  <li><strong>Zhen Xiong</strong>, Master@USC -> PhD student@NYU, first-author papers at ICLR 2026 and EMNLP 2025</li>
  <li><strong>Zhenlong Yuan</strong>, PhD@CAS, two first-author papers at ICLR 2026</li>
  <li><strong>Haonan Ge</strong>, Undergrad@SEU -> PhD student@UCSB, first-author paper at EMNLP 2025</li>
  <li><strong>Sifan Li</strong>, Master@Liaoning University -> PhD student@CAS, first-author oral paper at EMNLP 2025</li>
  <li><strong>Zhecheng Li</strong>, Master@UCSD -> TikTok US, first-author papers at ACL 2025 (x2), COLM 2025, and ACL 2024</li>
  <li><strong>Shuyang Hao</strong>, Undergrad@SEU -> PhD student@Lancaster, first-author papers at CVPR 2025 and EMNLP 2025</li>
  <li><strong>Cheng Wang</strong>, Undergrad@NUS, first-author papers at COLING 2025 and NAACL 2025</li>
  <!-- <li><strong>Haiji Liang</strong>, Master@ZJU -> PhD student@HKUST</li> -->
</ul>
...
## Contact
**Email** [vanora.caiyj@gmail.com](mailto:vanora.caiyj@gmail.com) <span style="color:#e74d3c;"><b>
